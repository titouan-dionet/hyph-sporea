...
class SporeCounterApp:
    ...
    def setup_ui(self):
        ...
        self.grid_nav_frame = ttk.LabelFrame(control_frame, text="Navigation d'image")
        ...
        try:
            ...
            if pixel_count > max_pixels:
                ...
                messagebox.showinfo(
                    ...
                    f"Utilisez les boutons de navigation pour passer d'une partie à l'autre."
                )
            else:
                ...
                # Convertir de BGR à RGB pour l'affichage PIL
